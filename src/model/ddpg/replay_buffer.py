...
class ReplayBuffer(object):
    ...
    def sample_batch(self, batch_size):
        ...
        s2_batch = np.array([experience[4][0] for experience in batch])
        w2_batch = np.array([experience[4][1] for experience in batch])


        return (s_batch, w_batch), a_batch, r_batch, t_batch, (s2_batch, w2_batch)
